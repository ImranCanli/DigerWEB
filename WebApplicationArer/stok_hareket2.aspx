<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="stok_hareket2.aspx.vb" Inherits="WebApplicationArer.stok_hareket2" %>
                ...
                <div class="data">
                    <div class="content-data">
                        <div class="head">
                            ...
                            <div>
                                <a href="Stok.aspx" class="popup-trigger" style="z-index: 2; height: 30px; margin: 5px; text-align: center;">Geri Dön</a>
                                <asp:Button runat="server" ID="hareketsil" Text="Kaldır" CssClass="popup-trigger" Style="z-index: 2; height: 30px; margin: 5px; border: none; outline: none;" OnClick="hareketsil_Click" />
                            </div>
                        </div>
                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="id" ClientInstanceName="ASPxGridView1" Width="100%">
                            ...
                            <SettingsBehavior ProcessFocusedRowChangedOnServer="true" AllowEllipsisInText="true" AllowFocusedRow="True" AllowSelectByRowClick="True" AllowSelectSingleRowOnly="true" />
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="Expr3" VisibleIndex="2" Caption="ID">
                                    <HeaderStyle Cursor="pointer" Font-Bold="True" ForeColor="#F87C1D" HorizontalAlign="Center" />
                                    <CellStyle HorizontalAlign="Center">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
