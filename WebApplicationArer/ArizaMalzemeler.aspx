<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ArizaMalzemeler.aspx.vb" Inherits="WebApplicationArer.ArizaMalzemeler" %>
    ...
    <form runat="server" id="form1">
        ...
        <section id="sidebar">
            ...
            <ul class="side-menu">
                ...
                <li><a href="periyodik.aspx"><i class='bx bx-time-five'></i>Periyodik Bakımlar</a></li>
            </ul>
        </section>
        <!-- sidebar -->
                    ...
                    <div class="content-data">
                        <div class="head">
                            <div class="denemecontainer">
                                <h3 style="color: #f87c1d;">ARIZA SARF</h3>
                        ...
                        <dx:ASPxGridView ID="ASPxGridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource4" KeyFieldName="id" ClientInstanceName="ASPxGridView1" Width="100%" CssClass="anagrid">
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn FieldName="tur" VisibleIndex="2" Caption="Tür" MinWidth="60">
                                    <HeaderStyle Cursor="pointer" Font-Bold="True" ForeColor="#F87C1D" HorizontalAlign="Center" />
                                    <CellStyle HorizontalAlign="Center">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="adet" VisibleIndex="4" Caption="Adet" MinWidth="60">
                                    <HeaderStyle Cursor="pointer" Font-Bold="True" ForeColor="#F87C1D" HorizontalAlign="Center" />
                                    <CellStyle HorizontalAlign="Center">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="mak_kod" VisibleIndex="5" Caption="Makine Kod" MinWidth="60">
                                    <HeaderStyle Cursor="pointer" Font-Bold="True" ForeColor="#F87C1D" HorizontalAlign="Center" />
                                    <CellStyle HorizontalAlign="Center">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="isletme_tur" VisibleIndex="6" Caption="İşletme Türü">
                                    <HeaderStyle Cursor="pointer" Font-Bold="True" ForeColor="#F87C1D" HorizontalAlign="Center" />
                                    <CellStyle HorizontalAlign="Center">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="islem_yapan" VisibleIndex="7" Caption="İşlem Yapan">
                                    <HeaderStyle Cursor="pointer" Font-Bold="True" ForeColor="#F87C1D" HorizontalAlign="Center" />
                                    <CellStyle HorizontalAlign="Center">
                                    </CellStyle>
                                </dx:GridViewDataTextColumn>
